        ...
        <div className="min-h-screen flex flex-col bg-slate-50">
            ...
            <main className="flex-1 py-32 container px-4 md:px-6 mx-auto">
                ...
                <div className="overflow-x-auto pb-8">
                    <div className="min-w-[900px] pt-8">
                        <div className="grid grid-cols-6 gap-4 mb-4 items-end">
                            <div className="col-span-1"></div>
                            {/* Jobs */}
                            <div className="col-span-1 bg-white rounded-t-xl border-t-4 border-blue-500 p-4 shadow-lg relative transform -translate-y-2 z-10">
                                ...
                                <div className="text-center font-bold text-xl text-slate-900">退職代行Jobs</div>
                                <div className="text-center text-xs text-slate-500 mt-1">弁護士監修×労働組合</div>
                            </div>
                            {/* Guardian */}
                            <div className="col-span-1 bg-white rounded-t-xl border-t-4 border-emerald-500 p-4 shadow-lg relative transform -translate-y-2 z-10">
                                ...
                                <div className="text-center font-bold text-xl text-slate-900">ガーディアン</div>
                                <div className="text-center text-xs text-slate-500 mt-1">労働組合法人</div>
                            </div>
                            {/* 退職110番 */}
                            <div className="col-span-1 bg-white rounded-t-xl border-t-4 border-amber-500 p-4 shadow-lg relative transform -translate-y-2 z-10">
                                ...
                                <div className="text-center font-bold text-xl text-slate-900">退職110番</div>
                                <div className="text-center text-xs text-slate-500 mt-1">弁護士法人</div>
                            </div>
                            {/* Generic Cheap */}
                            <div className="col-span-1 p-4 text-center opacity-60">
                                <div className="font-bold text-lg text-slate-700">格安業者A</div>
                                <div className="text-xs text-slate-500 mt-1">民間企業</div>
                            </div>
                            {/* Generic Lawyer */}
                            <div className="col-span-1 p-4 text-center opacity-60">
                                <div className="font-bold text-lg text-slate-700">一般弁護士B</div>
                                <div className="text-xs text-slate-500 mt-1">個人事務所</div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-6 gap-4 bg-white p-4 rounded-lg shadow-sm items-center hover:shadow-md transition-shadow">
                                ...
                                <div className="text-center font-bold text-blue-600 text-lg">¥24,000</div>
                            ...
                            <div className="grid grid-cols-6 gap-4 bg-white p-4 rounded-lg shadow-sm items-center hover:shadow-md transition-shadow">
                                ...
                                <div className="text-center text-sm font-medium text-blue-600">安心（弁護士監修）</div>
                                <div className="text-center text-sm font-medium text-emerald-600">安心（法適合）</div>
                                <div className="text-center text-sm font-bold text-amber-600">万全（弁護士）</div>
                            ...
                            <div className="grid grid-cols-6 gap-4 bg-white p-4 rounded-lg shadow-sm items-center hover:shadow-md transition-shadow">
                                ...
                                <div className="text-center font-bold text-blue-600">全額返金保証あり</div>
                                <div className="text-center font-bold text-emerald-600">なし</div>
                                <div className="text-center text-slate-500">全額返金保証あり</div>
                            ...
                            <div className="grid grid-cols-6 gap-4 bg-white p-4 rounded-lg shadow-sm items-center hover:shadow-md transition-shadow">
                                ...
                                <div className="text-center font-bold text-blue-600">無料サポート付き</div>
                                <div className="text-center text-slate-500">なし</div>
                                <div className="text-center text-slate-500">なし</div>
                                <div className="text-center text-slate-500">なし</div>
                                <div className="text-center text-slate-500">なし</div>
                ...
                <div className="text-center text-xs text-slate-400 mt-4">※退職110番は基本料金43,800円のほか、金銭請求時に成功報酬（回収額の20〜30%）が別途発生します。※退職代行Jobsの24,000円は安心パックプラン（労働組合加入込み）の料金です。</div>
                ...
                <div className="mt-16 bg-white p-8 rounded-2xl shadow-sm border border-slate-100 max-w-4xl mx-auto">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-lg font-bold text-blue-700 mb-2">1. 「民間業者」は絶対に避けるべき</h3>
